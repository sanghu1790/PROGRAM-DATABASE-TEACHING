...
{ int IoBuildDeviceIoControlRequest_malloc_ret ;
  ...
  {
  customIrp = 1;
  scanf("%d", &IoBuildDeviceIoControlRequest_tmp_ndt_7);
...
{ int IofCallDriver_returnVal2 ;
  ...
  if (IofCallDriver_tmp_ndt_8 >= 0) {
    ...
    _L___0: /* CIL Label */ 
    scanf("%d", &IofCallDriver_tmp_ndt_9);
...
{ int KeWaitForSingleObject_tmp_ndt_10 ;
  ...
  scanf("%d", &KeWaitForSingleObject_tmp_ndt_10);
...
{ int PoCallDriver_compRetStatus ;
  ...
  scanf("%d", &PoCallDriver_tmp_ndt_11);
  if (PoCallDriver_tmp_ndt_11 >= 0) {
    ...
    _L___1: /* CIL Label */ 
    scanf("%d", &PoCallDriver_tmp_ndt_12);
