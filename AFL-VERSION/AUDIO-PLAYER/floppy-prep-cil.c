...
{ int IoBuildDeviceIoControlRequest_malloc ;
  ...
  {
  customIrp = 1;
  scanf("%d", &IoBuildDeviceIoControlRequest_tmp_ndt_2);
...
{ int IoDeleteSymbolicLink_tmp_ndt_3 ;
  ...
  {
  scanf("%d", &IoDeleteSymbolicLink_tmp_ndt_3);
...
{ int IoRegisterDeviceInterface_tmp_ndt_5 ;
  ...
  {
  scanf("%d", &IoRegisterDeviceInterface_tmp_ndt_5);
...
{ int IoSetDeviceInterfaceState_tmp_ndt_6 ;
  ...
  {
  scanf("%d", &IoSetDeviceInterfaceState_tmp_ndt_6);
...
{ int IofCallDriver_returnVal2 ;
  ...
  scanf("%d", &IofCallDriver_tmp_ndt_7);
  if (IofCallDriver_tmp_ndt_7 >= 0) {
    ...
    _L___0: /* CIL Label */ 
    scanf("%d", &IofCallDriver_tmp_ndt_8);
...
{ int KeWaitForSingleObject_tmp_ndt_9 ;
  ...
  scanf("%d", &KeWaitForSingleObject_tmp_ndt_9);
...
{ int ObReferenceObjectByHandle_tmp_ndt_10 ;
  ...
  {
  scanf("%d", &ObReferenceObjectByHandle_tmp_ndt_10);
...
{ int PsCreateSystemThread_tmp_ndt_11 ;
  ...
  {
  scanf("%d", &PsCreateSystemThread_tmp_ndt_11);
