...
{ 
  ...
  scanf("%d", &s);
  scanf("%d", &pended);
  scanf("%d", &compRegistered);
  scanf("%d", &lowerDriverReturn);
  scanf("%d", &setEventCalled);
  scanf("%d", &customIrp);
  return;
}
}
...
{ int IoBuildDeviceIoControlRequest_malloc ;
  ...
  {
  customIrp = 1;
  scanf("%d", &IoBuildDeviceIoControlRequest_tmp_ndt_5);
...
{ int IoDeleteSymbolicLink_tmp_ndt_6 ;
  ...
  {
  scanf("%d", &IoDeleteSymbolicLink_tmp_ndt_6);
...
{ int IoRegisterDeviceInterface_tmp_ndt_8 ;
  ...
  {
  scanf("%d", &IoRegisterDeviceInterface_tmp_ndt_8);
...
{ int IoSetDeviceInterfaceState_tmp_ndt_9 ;
  ...
  {
  scanf("%d", &IoSetDeviceInterfaceState_tmp_ndt_9);
...
{ int IofCallDriver_returnVal2 ;
  ...
  scanf("%d", &IofCallDriver_tmp_ndt_10);
  if (IofCallDriver_tmp_ndt_10 >= 0) {
    ...
    _L___0: /* CIL Label */ 
    scanf("%d", &IofCallDriver_tmp_ndt_11);
...
{ int KeWaitForSingleObject_tmp_ndt_12 ;
  ...
  scanf("%d", &KeWaitForSingleObject_tmp_ndt_12);
...
{ int ObReferenceObjectByHandle_tmp_ndt_13 ;
  ...
  {
  scanf("%d", &ObReferenceObjectByHandle_tmp_ndt_13);
...
{ int PsCreateSystemThread_tmp_ndt_14 ;
  ...
  {
  scanf("%d", &PsCreateSystemThread_tmp_ndt_14);
