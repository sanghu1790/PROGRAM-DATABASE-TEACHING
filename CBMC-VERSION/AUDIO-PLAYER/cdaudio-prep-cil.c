            ...
            if (CdAudio535DeviceControl_currentIrpStack__Parameters__DeviceIoControl__OutputBufferLength < 0) {
              ...
              if (CdAudio535DeviceControl_lastSession >= 0) {
                ...
                if (CdAudio535DeviceControl_TRACER_returning <= 0) {
                  ...
                  if (CdAudio535DeviceControl_lastSession__LogicalBlockAddress > 0) {
  ...
  if (CdAudio435DeviceControl_currentIrpStack__Parameters__DeviceIoControl__IoControlCode >= CdAudio435DeviceControl_CIL___Tmp37) {
                  ...
                  if (CdAudio435DeviceControl_CIL___Tmp95 < -1073741764) {
                    ...
                    if (CdAudio435DeviceControl_CIL___Tmp96 > -1073741764) {
                      ...
                      if (CdAudio435DeviceControl_CIL___Tmp96 < -1073741764) {
                        ...
                        if (CdAudio435DeviceControl_CIL___Tmp97 >= -2147483626) {
                          if (CdAudio435DeviceControl_CIL___Tmp97 <= -2147483626) {
                            CdAudio435DeviceControl_Irp__IoStatus__Information = 0;
                          }
                        }
    ...
    if (CdAudio435DeviceControl_currentIrpStack__Parameters__DeviceIoControl__IoControlCode >= CdAudio435DeviceControl_CIL___Tmp42) {
      if (CdAudio435DeviceControl_currentIrpStack__Parameters__DeviceIoControl__IoControlCode <= CdAudio435DeviceControl_CIL___Tmp42) {
        ...
        if (CdAudio435DeviceControl_currentIrpStack__Parameters__DeviceIoControl__IoControlCode >= CdAudio435DeviceControl_CIL___Tmp103) {
          if (CdAudio435DeviceControl_currentIrpStack__Parameters__DeviceIoControl__IoControlCode <= CdAudio435DeviceControl_CIL___Tmp103) {
                ...
                if (CdAudio435DeviceControl_deviceExtension__Paused >= 1) {
                  ...
                  if (CdAudio435DeviceControl_status < 0) {
                    ...
                    if (CdAudio435DeviceControl_status < 0) {
                      ...
                      if (CdAudio435DeviceControl_CIL___Tmp111 >= -2147483626) {
                        if (CdAudio435DeviceControl_CIL___Tmp111 <= -2147483626) {
                          CdAudio435DeviceControl_Irp__IoStatus__Information = 0;
                        }
                      }
                  ...
                  if (CdAudio435DeviceControl_currentIrpStack__Parameters__DeviceIoControl__OutputBufferLength < CdAudio435DeviceControl_sizeof__SUB_Q_CURRENT_POSITION) {
                    ...
                    if (CdAudio435DeviceControl_SubQPtr___0 >= 0) {
                      if (CdAudio435DeviceControl_SubQPtr___0 <= 0) {
                        ...
                        if (CdAudio435DeviceControl_CIL___Tmp113 >= -2147483626) {
                          if (CdAudio435DeviceControl_CIL___Tmp113 <= -2147483626) {
                            CdAudio435DeviceControl_Irp__IoStatus__Information = 0;
                          }
                        }
                      ...
                      if (CdAudio435DeviceControl_userPtr__Format > 1) {
                        ...
                        if (CdAudio435DeviceControl_userPtr__Format < 1) {
                          ...
                          if (CdAudio435DeviceControl_CIL___Tmp114 >= -2147483626) {
                            if (CdAudio435DeviceControl_CIL___Tmp114 <= -2147483626) {
                              CdAudio435DeviceControl_Irp__IoStatus__Information = 0;
                            }
                          }
                          ...
                          if (CdAudio435DeviceControl_currentIrpStack__Parameters__DeviceIoControl__IoControlCode <= CdAudio435DeviceControl_CIL___Tmp92) {
                            ...
                            if (CdAudio435DeviceControl_tmp___1 >= 1) {
                              if (CdAudio435DeviceControl_tmp___1 <= 1) {
                                ...
                                if (CdAudio435DeviceControl_CIL___Tmp115 >= -2147483626) {
                                  if (CdAudio435DeviceControl_CIL___Tmp115 <= -2147483626) {
                                    CdAudio435DeviceControl_Irp__IoStatus__Information = 0;
                                  }
                                }
...
{ int IofCallDriver_Irp__PendingReturned ;
  ...
  if (IofCallDriver_Irp__PendingReturned > 0) {
    ...
    if (IofCallDriver_Irp__PendingReturned < 0) {
      ...
      IofCallDriver_tmp_ndt_5 = nondet_int(); __CPROVER_input("IofCallDriver_tmp_ndt_5",IofCallDriver_tmp_ndt_5);
      if (IofCallDriver_tmp_ndt_5 >= 0) {
        ...
        _L___1: /* CIL Label */ 
        IofCallDriver_tmp_ndt_6 = nondet_int(); __CPROVER_input("IofCallDriver_tmp_ndt_6",IofCallDriver_tmp_ndt_6);
...
{ int KeWaitForSingleObject_tmp_ndt_7 ;
  ...
  KeWaitForSingleObject_tmp_ndt_7 = nondet_int(); __CPROVER_input("KeWaitForSingleObject_tmp_ndt_7",KeWaitForSingleObject_tmp_ndt_7);
...
{ int PoCallDriver_compRetStatus ;
  ...
  PoCallDriver_tmp_ndt_8 = nondet_int(); __CPROVER_input("PoCallDriver_tmp_ndt_8",PoCallDriver_tmp_ndt_8);
  if (PoCallDriver_tmp_ndt_8 >= 0) {
    ...
    _L___1: /* CIL Label */ 
    PoCallDriver_tmp_ndt_9 = nondet_int(); __CPROVER_input("PoCallDriver_tmp_ndt_9",PoCallDriver_tmp_ndt_9);
...
{ int ZwClose_tmp_ndt_10 ;
  ...
  {
  ZwClose_tmp_ndt_10 = nondet_int(); __CPROVER_input("ZwClose_tmp_ndt_10",ZwClose_tmp_ndt_10);
