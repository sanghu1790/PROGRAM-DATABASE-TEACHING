      ...
      if (main_tmp_ndt_2 >= 2) {
        ...
        if (main_tmp_ndt_3 >= 3) {
          ...
          if (main_tmp_ndt_4 >= 4) {
            ...
            _L: /* CIL Label */ 
            main_tmp_ndt_5 = nondet_int(); __CPROVER_input("main_tmp_ndt_5",main_tmp_ndt_5);
...
{ int IoBuildDeviceIoControlRequest_malloc_ret ;
  ...
  {
  customIrp = 1;
  IoBuildDeviceIoControlRequest_tmp_ndt_7 = nondet_int(); __CPROVER_input("IoBuildDeviceIoControlRequest_tmp_ndt_7",IoBuildDeviceIoControlRequest_tmp_ndt_7);
...
{ int IofCallDriver_returnVal2 ;
  ...
  if (IofCallDriver_tmp_ndt_8 >= 0) {
    ...
    _L___0: /* CIL Label */ 
    IofCallDriver_tmp_ndt_9 = nondet_int(); __CPROVER_input("IofCallDriver_tmp_ndt_9",IofCallDriver_tmp_ndt_9);
...
{ int KeWaitForSingleObject_tmp_ndt_10 ;
  ...
  KeWaitForSingleObject_tmp_ndt_10 = nondet_int(); __CPROVER_input("KeWaitForSingleObject_tmp_ndt_10",KeWaitForSingleObject_tmp_ndt_10);
...
{ int PoCallDriver_compRetStatus ;
  ...
  PoCallDriver_tmp_ndt_11 = nondet_int(); __CPROVER_input("PoCallDriver_tmp_ndt_11",PoCallDriver_tmp_ndt_11);
  if (PoCallDriver_tmp_ndt_11 >= 0) {
    ...
    _L___1: /* CIL Label */ 
    PoCallDriver_tmp_ndt_12 = nondet_int(); __CPROVER_input("PoCallDriver_tmp_ndt_12",PoCallDriver_tmp_ndt_12);
