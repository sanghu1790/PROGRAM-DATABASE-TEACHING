...
{ int IoBuildDeviceIoControlRequest_malloc ;
  ...
  {
  customIrp = 1;
  IoBuildDeviceIoControlRequest_tmp_ndt_2 = nondet_int(); __CPROVER_input("IoBuildDeviceIoControlRequest_tmp_ndt_2",IoBuildDeviceIoControlRequest_tmp_ndt_2);
...
{ int IoDeleteSymbolicLink_tmp_ndt_3 ;
  ...
  {
  IoDeleteSymbolicLink_tmp_ndt_3 = nondet_int(); __CPROVER_input("IoDeleteSymbolicLink_tmp_ndt_3",IoDeleteSymbolicLink_tmp_ndt_3);
...
{ int IoRegisterDeviceInterface_tmp_ndt_5 ;
  ...
  {
  IoRegisterDeviceInterface_tmp_ndt_5 = nondet_int(); __CPROVER_input("IoRegisterDeviceInterface_tmp_ndt_5",IoRegisterDeviceInterface_tmp_ndt_5);
...
{ int IoSetDeviceInterfaceState_tmp_ndt_6 ;
  ...
  {
  IoSetDeviceInterfaceState_tmp_ndt_6 = nondet_int(); __CPROVER_input("IoSetDeviceInterfaceState_tmp_ndt_6",IoSetDeviceInterfaceState_tmp_ndt_6);
...
{ int IofCallDriver_returnVal2 ;
  ...
  IofCallDriver_tmp_ndt_7 = nondet_int(); __CPROVER_input("IofCallDriver_tmp_ndt_7",IofCallDriver_tmp_ndt_7);
  if (IofCallDriver_tmp_ndt_7 >= 0) {
    ...
    _L___0: /* CIL Label */ 
    IofCallDriver_tmp_ndt_8 = nondet_int(); __CPROVER_input("IofCallDriver_tmp_ndt_8",IofCallDriver_tmp_ndt_8);
...
{ int KeWaitForSingleObject_tmp_ndt_9 ;
  ...
  KeWaitForSingleObject_tmp_ndt_9 = nondet_int(); __CPROVER_input("KeWaitForSingleObject_tmp_ndt_9",KeWaitForSingleObject_tmp_ndt_9);
...
{ int ObReferenceObjectByHandle_tmp_ndt_10 ;
  ...
  {
  ObReferenceObjectByHandle_tmp_ndt_10 = nondet_int(); __CPROVER_input("ObReferenceObjectByHandle_tmp_ndt_10",ObReferenceObjectByHandle_tmp_ndt_10);
...
{ int PsCreateSystemThread_tmp_ndt_11 ;
  ...
  {
  PsCreateSystemThread_tmp_ndt_11 = nondet_int(); __CPROVER_input("PsCreateSystemThread_tmp_ndt_11",PsCreateSystemThread_tmp_ndt_11);
...
{ int ZwClose_tmp_ndt_12 ;
  ...
  {
  ZwClose_tmp_ndt_12 = nondet_int(); __CPROVER_input("ZwClose_tmp_ndt_12",ZwClose_tmp_ndt_12);
