...
{ 
  ...
  {
  UNLOADED = nondet_int(); __CPROVER_input("UNLOADED",UNLOADED);
  NP = nondet_int(); __CPROVER_input("NP",NP);
  DC = nondet_int(); __CPROVER_input("DC",DC);
  SKIP1 = nondet_int(); __CPROVER_input("SKIP1",SKIP1);
  SKIP2 = nondet_int(); __CPROVER_input("SKIP2",SKIP2);
  MPR1 = nondet_int(); __CPROVER_input("MPR1",MPR1);
  MPR3 = nondet_int(); __CPROVER_input("MPR3",MPR3);
  IPC = nondet_int(); __CPROVER_input("IPC",IPC);
  s = nondet_int(); __CPROVER_input("s",s);
  pended = nondet_int(); __CPROVER_input("pended",pended);
  compRegistered = nondet_int(); __CPROVER_input("compRegistered",compRegistered);
  lowerDriverReturn = nondet_int(); __CPROVER_input("lowerDriverReturn",lowerDriverReturn);
  setEventCalled = nondet_int(); __CPROVER_input("setEventCalled",setEventCalled);
  customIrp = nondet_int(); __CPROVER_input("customIrp",customIrp);
  return;
}
}
  ...
  if (FloppyStartDevice_ntStatus >= 0) {
    ...
    if (FloppyStartDevice_ntStatus >= 0) {
      if (FloppyStartDevice_KUSER_SHARED_DATA__AlternativeArchitecture_NEC98x86 > 0) {
        ...
        FloppyStartDevice_disketteExtension__DriveOnValue = FloppyStartDevice_fdcInfo__UnitNumber;
      } else {
        if (FloppyStartDevice_KUSER_SHARED_DATA__AlternativeArchitecture_NEC98x86 < 0) {
          FloppyStartDevice_disketteExtension__DeviceUnit = FloppyStartDevice_fdcInfo__UnitNumber;
          FloppyStartDevice_disketteExtension__DriveOnValue = FloppyStartDevice_fdcInfo__UnitNumber;
...
{ int main_status ;
  ...
  stub_driver_init();
  main_tmp_ndt_1 = nondet_int(); __CPROVER_input("main_tmp_ndt_1",main_tmp_ndt_1);
  if (main_tmp_ndt_1 >= 0) {
    if (main_tmp_ndt_1 <= 0) {
    ...
    _L___1: /* CIL Label */ 
    main_tmp_ndt_2 = nondet_int(); __CPROVER_input("main_tmp_ndt_2",main_tmp_ndt_2);
    if (main_tmp_ndt_2 >= 1) {
      if (main_tmp_ndt_2 <= 1) {
        main_status = FloppyCreateClose(main_devobj, main_pirp);
      } else {
      ...
      _L___0: /* CIL Label */ 
      main_tmp_ndt_3 = nondet_int(); __CPROVER_input("main_tmp_ndt_3",main_tmp_ndt_3);
      if (main_tmp_ndt_3 >= 2) {
        if (main_tmp_ndt_3 <= 2) {
        ...
        _L: /* CIL Label */ 
        main_tmp_ndt_4 = nondet_int(); __CPROVER_input("main_tmp_ndt_4",main_tmp_ndt_4);
        if (main_tmp_ndt_4 >= 3) {
          if (main_tmp_ndt_4 <= 3) {
...
{ int IoBuildDeviceIoControlRequest_malloc ;
  ...
  {
  customIrp = 1;
  IoBuildDeviceIoControlRequest_tmp_ndt_5 = nondet_int(); __CPROVER_input("IoBuildDeviceIoControlRequest_tmp_ndt_5",IoBuildDeviceIoControlRequest_tmp_ndt_5);
...
{ int IoDeleteSymbolicLink_tmp_ndt_6 ;
  ...
  {
  IoDeleteSymbolicLink_tmp_ndt_6 = nondet_int(); __CPROVER_input("IoDeleteSymbolicLink_tmp_ndt_6",IoDeleteSymbolicLink_tmp_ndt_6);
...
{ int IoRegisterDeviceInterface_tmp_ndt_8 ;
  ...
  {
  IoRegisterDeviceInterface_tmp_ndt_8 = nondet_int(); __CPROVER_input("IoRegisterDeviceInterface_tmp_ndt_8",IoRegisterDeviceInterface_tmp_ndt_8);
...
{ int IoSetDeviceInterfaceState_tmp_ndt_9 ;
  ...
  {
  IoSetDeviceInterfaceState_tmp_ndt_9 = nondet_int(); __CPROVER_input("IoSetDeviceInterfaceState_tmp_ndt_9",IoSetDeviceInterfaceState_tmp_ndt_9);
...
{ int IofCallDriver_returnVal2 ;
  ...
  IofCallDriver_tmp_ndt_10 = nondet_int(); __CPROVER_input("IofCallDriver_tmp_ndt_10",IofCallDriver_tmp_ndt_10);
  if (IofCallDriver_tmp_ndt_10 >= 0) {
    ...
    _L___0: /* CIL Label */ 
    IofCallDriver_tmp_ndt_11 = nondet_int(); __CPROVER_input("IofCallDriver_tmp_ndt_11",IofCallDriver_tmp_ndt_11);
...
{ int KeWaitForSingleObject_tmp_ndt_12 ;
  ...
  KeWaitForSingleObject_tmp_ndt_12 = nondet_int(); __CPROVER_input("KeWaitForSingleObject_tmp_ndt_12",KeWaitForSingleObject_tmp_ndt_12);
...
{ int ObReferenceObjectByHandle_tmp_ndt_13 ;
  ...
  {
  ObReferenceObjectByHandle_tmp_ndt_13 = nondet_int(); __CPROVER_input("ObReferenceObjectByHandle_tmp_ndt_13",ObReferenceObjectByHandle_tmp_ndt_13);
...
{ int PsCreateSystemThread_tmp_ndt_14 ;
  ...
  {
  PsCreateSystemThread_tmp_ndt_14 = nondet_int(); __CPROVER_input("PsCreateSystemThread_tmp_ndt_14",PsCreateSystemThread_tmp_ndt_14);
...
{ int ZwClose_tmp_ndt_15 ;
  ...
  {
  ZwClose_tmp_ndt_15 = nondet_int(); __CPROVER_input("ZwClose_tmp_ndt_15",ZwClose_tmp_ndt_15);
  ...
  if (FloppyDeviceControl_disketteExtension__HoldNewRequests > 0) {
    ...
    if (FloppyDeviceControl_disketteExtension__HoldNewRequests < 0) {
      ...
      if (FloppyDeviceControl_irpSp__Parameters__DeviceIoControl__IoControlCode___1 > FloppyDeviceControl_CIL___Tmp41) {
        FloppyDeviceControl_ntStatus = FloppyQueueRequest(FloppyDeviceControl_disketteExtension, FloppyDeviceControl_Irp);
      ...
      if (FloppyDeviceControl_disketteExtension__IsRemoved < 0) {
        ...
        if (FloppyDeviceControl_disketteExtension__IsStarted >= 0) {
          if (FloppyDeviceControl_disketteExtension__IsStarted <= 0) {
            ...
            FloppyDeviceControl_tmp = IofCallDriver(FloppyDeviceControl_disketteExtension__TargetObject, FloppyDeviceControl_Irp);
              ...
              if (FloppyDeviceControl_irpSp__Parameters__DeviceIoControl__IoControlCode___1 >= FloppyDeviceControl_CIL___Tmp50) {
                if (FloppyDeviceControl_irpSp__Parameters__DeviceIoControl__IoControlCode___1 <= FloppyDeviceControl_CIL___Tmp50) {
                  if (FloppyDeviceControl_irpSp__Parameters__DeviceIoControl__InputBufferLength < FloppyDeviceControl_sizeof__FORMAT_PARAMETERS) {
                    ...
                    FloppyDeviceControl_tmp___0 = FlCheckFormatParameters(FloppyDeviceControl_disketteExtension, FloppyDeviceControl_Irp__AssociatedIrp__SystemBuffer);
                    if (FloppyDeviceControl_tmp___0 >= 0) {
                      ...
                      if (FloppyDeviceControl_irpSp__Parameters__DeviceIoControl__IoControlCode___1 >= FloppyDeviceControl_CIL___Tmp88) {
                        if (FloppyDeviceControl_irpSp__Parameters__DeviceIoControl__IoControlCode___1 <= FloppyDeviceControl_CIL___Tmp88) {
                          if (FloppyDeviceControl_irpSp__Parameters__DeviceIoControl__InputBufferLength < FloppyDeviceControl_sizeof__FORMAT_EX_PARAMETERS) {
                            ...
                            FloppyDeviceControl_formatExParameters = FloppyDeviceControl_Irp__AssociatedIrp__SystemBuffer;
                      ...
                      if (TRACER_breaking <= 0) {
                        FloppyDeviceControl_ntStatus = FlQueueIrpToThread(FloppyDeviceControl_Irp, FloppyDeviceControl_disketteExtension);
                      }
                    }
                  }
                } else {
                            ...
                            if (FloppyDeviceControl_irpSp__Parameters__DeviceIoControl__IoControlCode___1 >= FloppyDeviceControl_CIL___Tmp75) {
                              ...
                              if (FloppyDeviceControl_irpSp__Parameters__DeviceIoControl__IoControlCode___1 >= FloppyDeviceControl_CIL___Tmp78) {
                                if (FloppyDeviceControl_irpSp__Parameters__DeviceIoControl__IoControlCode___1 <= FloppyDeviceControl_CIL___Tmp78) {
                                  ...
                                  FloppyDeviceControl_Irp__CurrentLocation = FloppyDeviceControl_Irp__CurrentLocation + 1;
                                  FloppyDeviceControl_Irp__Tail__Overlay__CurrentStackLocation = FloppyDeviceControl_Irp__Tail__Overlay__CurrentStackLocation + 1;
                                  FloppyDeviceControl_ntStatus = IofCallDriver(FloppyDeviceControl_disketteExtension__TargetObject, FloppyDeviceControl_Irp);
                                  retres58 = FloppyDeviceControl_ntStatus;
                                  TRACER_returning = 1;
                                } else {
                                  goto _L___8;
          ...
          if (TRACER_returning <= 0) {
            ...
            if (FloppyDeviceControl_CIL___Tmp91 > 259) {
              FloppyDeviceControl_Irp__IoStatus__Status___0 = FloppyDeviceControl_ntStatus;
