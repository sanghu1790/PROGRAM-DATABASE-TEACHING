...
{ int IofCallDriver_returnVal2 ;
  ...
  IofCallDriver_tmp_ndt_2 = nondet_int(); __CPROVER_input("IofCallDriver_tmp_ndt_2",IofCallDriver_tmp_ndt_2);
  if (IofCallDriver_tmp_ndt_2 >= 0) {
    ...
    _L: /* CIL Label */ 
    IofCallDriver_tmp_ndt_3 = nondet_int(); __CPROVER_input("IofCallDriver_tmp_ndt_3",IofCallDriver_tmp_ndt_3);
...
{ int KeWaitForSingleObject_tmp_ndt_4 ;
  ...
  KeWaitForSingleObject_tmp_ndt_4 = nondet_int(); __CPROVER_input("KeWaitForSingleObject_tmp_ndt_4",KeWaitForSingleObject_tmp_ndt_4);
