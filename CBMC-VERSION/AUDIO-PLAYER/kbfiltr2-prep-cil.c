...
{ 
  ...
  compFptr = nondet_int(); __CPROVER_input("compFptr",compFptr);
...
{ int KeWaitForSingleObject_tmp_ndt_8 ;
  ...
  KeWaitForSingleObject_tmp_ndt_8 = nondet_int(); __CPROVER_input("KeWaitForSingleObject_tmp_ndt_8",KeWaitForSingleObject_tmp_ndt_8);
...
{ int PoCallDriver_compRetStatus ;
  ...
  if (PoCallDriver_tmp_ndt_9 >= 0) {
    ...
    _L___0: /* CIL Label */ 
    PoCallDriver_tmp_ndt_10 = nondet_int(); __CPROVER_input("PoCallDriver_tmp_ndt_10",PoCallDriver_tmp_ndt_10);
