...
{ int tmp_var ;
  ...
  FLAG1 = 0;
  while (FLAG1 < BOUND1) {
    symbb1 = nondet_int(); __CPROVER_input("symbb1",symbb1);
    token = symbb1;
    local = token;
    E_1 = 1;
    immediate_notify();
...
{ int tmp ;
  ...
  while (FLAG2 < BOUND2) {
    ...
    symb3 = nondet_int(); __CPROVER_input("symb3",symb3);
    symb4 = nondet_int(); __CPROVER_input("symb4",symb4);
    symb5 = nondet_int(); __CPROVER_input("symb5",symb5);
    symb6 = nondet_int(); __CPROVER_input("symb6",symb6);
    symb7 = nondet_int(); __CPROVER_input("symb7",symb7);
    symb8 = nondet_int(); __CPROVER_input("symb8",symb8);
    symb9 = nondet_int(); __CPROVER_input("symb9",symb9);
    symb10 = nondet_int(); __CPROVER_input("symb10",symb10);
    symb11 = nondet_int(); __CPROVER_input("symb11",symb11);
    symb12 = nondet_int(); __CPROVER_input("symb12",symb12);
    symb13 = nondet_int(); __CPROVER_input("symb13",symb13);
    symb14 = nondet_int(); __CPROVER_input("symb14",symb14);
