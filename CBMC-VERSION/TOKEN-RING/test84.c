//This program is token_ring.15_false-unreach-call_false-termination.cil.c
...
{ 
  int tmp_var;
  tmp_var = nondet_int(); __CPROVER_input("tmp_var",tmp_var);
  {
  if (m_pc == 0) {
    goto M_ENTRY;
  } else {
...
void eval(void) 
{
  ...
  {
  {
        ...
        int symb2[BOUND2][15];
	klee_make_symbolic(symb2, sizeof(int) * BOUND2 * 15, "symb2");
