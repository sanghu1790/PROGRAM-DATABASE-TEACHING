...
{ int IofCallDriver_Irp__PendingReturned ;
  ...
  if (IofCallDriver_Irp__PendingReturned > 0) {
    ...
    if (IofCallDriver_Irp__PendingReturned < 0) {
      ...
      klee_make_symbolic(& IofCallDriver_tmp_ndt_5, sizeof(int ), "IofCallDriver_tmp_ndt_5");
...
{ int KeWaitForSingleObject_tmp_ndt_7 ;
  ...
  klee_make_symbolic(& KeWaitForSingleObject_tmp_ndt_7, sizeof(int ), "KeWaitForSingleObject_tmp_ndt_7");
...
{ int PoCallDriver_compRetStatus ;
  ...
  klee_make_symbolic(& PoCallDriver_tmp_ndt_8, sizeof(int ), "PoCallDriver_tmp_ndt_8");
