...
{ int IoBuildDeviceIoControlRequest_malloc ;
  ...
  {
  customIrp = 1;
  klee_make_symbolic(& IoBuildDeviceIoControlRequest_tmp_ndt_2, sizeof(int ), "IoBuildDeviceIoControlRequest_tmp_ndt_2");
...
{ int IoDeleteSymbolicLink_tmp_ndt_3 ;
  ...
  {
  klee_make_symbolic(& IoDeleteSymbolicLink_tmp_ndt_3, sizeof(int ), "IoDeleteSymbolicLink_tmp_ndt_3");
...
{ int IoRegisterDeviceInterface_tmp_ndt_5 ;
  ...
  {
  klee_make_symbolic(& IoRegisterDeviceInterface_tmp_ndt_5, sizeof(int ), "IoRegisterDeviceInterface_tmp_ndt_5");
...
{ int IoSetDeviceInterfaceState_tmp_ndt_6 ;
  ...
  {
  klee_make_symbolic(& IoSetDeviceInterfaceState_tmp_ndt_6, sizeof(int ), "IoSetDeviceInterfaceState_tmp_ndt_6");
...
{ int KeWaitForSingleObject_tmp_ndt_9 ;
  ...
  klee_make_symbolic(& KeWaitForSingleObject_tmp_ndt_9, sizeof(int ), "KeWaitForSingleObject_tmp_ndt_9");
...
{ int ObReferenceObjectByHandle_tmp_ndt_10 ;
  ...
  {
  klee_make_symbolic(& ObReferenceObjectByHandle_tmp_ndt_10, sizeof(int ), "ObReferenceObjectByHandle_tmp_ndt_10");
...
{ int PsCreateSystemThread_tmp_ndt_11 ;
  ...
  {
  klee_make_symbolic(& PsCreateSystemThread_tmp_ndt_11, sizeof(int ), "PsCreateSystemThread_tmp_ndt_11");
