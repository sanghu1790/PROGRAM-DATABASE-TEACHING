...
{ int IoBuildDeviceIoControlRequest_malloc ;
  ...
  {
  customIrp = 1;
  klee_make_symbolic(& IoBuildDeviceIoControlRequest_tmp_ndt_5, sizeof(int ), "IoBuildDeviceIoControlRequest_tmp_ndt_5");
...
{ int IoDeleteSymbolicLink_tmp_ndt_6 ;
  ...
  {
  klee_make_symbolic(& IoDeleteSymbolicLink_tmp_ndt_6, sizeof(int ), "IoDeleteSymbolicLink_tmp_ndt_6");
...
{ int IoRegisterDeviceInterface_tmp_ndt_8 ;
  ...
  {
  klee_make_symbolic(& IoRegisterDeviceInterface_tmp_ndt_8, sizeof(int ), "IoRegisterDeviceInterface_tmp_ndt_8");
...
{ int IoSetDeviceInterfaceState_tmp_ndt_9 ;
  ...
  {
  klee_make_symbolic(& IoSetDeviceInterfaceState_tmp_ndt_9, sizeof(int ), "IoSetDeviceInterfaceState_tmp_ndt_9");
...
{ int IofCallDriver_returnVal2 ;
  ...
  klee_make_symbolic(& IofCallDriver_tmp_ndt_10, sizeof(int ), "IofCallDriver_tmp_ndt_10");
  if (IofCallDriver_tmp_ndt_10 >= 0) {
    ...
    _L___0: /* CIL Label */ 
    klee_make_symbolic(& IofCallDriver_tmp_ndt_11, sizeof(int ), "IofCallDriver_tmp_ndt_11");
...
{ int KeWaitForSingleObject_tmp_ndt_12 ;
  ...
  klee_make_symbolic(& KeWaitForSingleObject_tmp_ndt_12, sizeof(int ), "KeWaitForSingleObject_tmp_ndt_12");
...
{ int ObReferenceObjectByHandle_tmp_ndt_13 ;
  ...
  {
  klee_make_symbolic(& ObReferenceObjectByHandle_tmp_ndt_13, sizeof(int ), "ObReferenceObjectByHandle_tmp_ndt_13");
...
{ int PsCreateSystemThread_tmp_ndt_14 ;
  ...
  {
  klee_make_symbolic(& PsCreateSystemThread_tmp_ndt_14, sizeof(int ), "PsCreateSystemThread_tmp_ndt_14");
